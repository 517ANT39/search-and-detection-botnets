...
def api_list():
    ...
    return jsonify({
        "items": [{
            "id": a.id, "host_id": a.host_id, "alert_type": a.alert_type,
            "severity": a.severity, "title": a.title, "description": a.description,
            "src_ip": a.src_ip, "dst_ip": a.dst_ip, "is_resolved": a.is_resolved,
            "created_at": a.created_at.isoformat(), "details": a.details_json,
        } for a in pag.items],
